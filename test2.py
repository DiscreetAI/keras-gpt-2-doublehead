...
with open('valid_mc_labels.json', 'r') as f:
    mc_labels = json.load(f)

with open('valid_mc_token_ids.json', 'r') as f:
    mc_token_ids = json.load(f)

print(len(mc_labels))
mc_labels = [mc_labels[0]]*len(mc_token_ids)
print(len(mc_labels))

with open('valid_mc_labels.json', 'w') as f:
